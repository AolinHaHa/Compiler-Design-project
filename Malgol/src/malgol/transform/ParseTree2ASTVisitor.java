...
public class ParseTree2ASTVisitor implements Analysis {
	...
	@Override
	public void caseABlockProgram(ABlockProgram node) {
		node.getBlock().apply(this);
		BlockStatement block = (BlockStatement) statementResult;
		programResult = new Program(block);
	}
	
	@Override
	public void caseAFunDefProgram(AFunDef node){
		node.getL_par().apply(this);
